...
func _test_compact_dive_hud_helpers() -> void:
	...
	_expect(_control_rect(scan_card_panel).encloses(_control_rect(scan_target_label)), "scan target should stay inside the dedicated scan card")
	_expect(_control_rect(scan_card_panel).encloses(_control_rect(scan_card_meta_label)), "scan metadata should stay inside the dedicated scan card")
	_expect(_control_rect(scan_card_panel).encloses(_control_rect(scan_card_prompt_label)), "scan prompt should stay inside the dedicated scan card")
	...
	_expect(not scan_card_panel.visible, "surface-ready state should hide the active scan card")
...
func _test_active_hud_final_polish_regression() -> void:
	...
	_expect(not scan_card_panel.visible, "raw scene should start with the active scan card hidden")
