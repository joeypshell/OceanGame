...
@onready var glow_plankton_visual: Polygon2D = $ResourcePickups/GlowPlankton/FallbackVisual/Visual
...
@onready var pressure_shimmer: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureShimmer
@onready var pressure_gate_top: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureGateTop
@onready var pressure_gate_bottom: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureGateBottom
@onready var pressure_gate_bar_a: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureGateBarA
@onready var pressure_gate_bar_b: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureGateBarB
@onready var pressure_gate_bar_c: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureGateBarC
@onready var pressure_gate_left_rail: Polygon2D = $PressureLockedWreck/FallbackGeometry/GateLeftRail
@onready var pressure_gate_right_rail: Polygon2D = $PressureLockedWreck/FallbackGeometry/GateRightRail
@onready var pressure_lock_badge: Polygon2D = $PressureLockedWreck/FallbackGeometry/PressureLockBadge
@onready var pressure_label: Label = $PressureLockedWreck/FallbackGeometry/PressureLabel
