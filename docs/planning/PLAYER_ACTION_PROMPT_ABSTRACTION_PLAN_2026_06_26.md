...
Status: helper, current prompt routing, and guard coverage complete; copy review remains next.
...
3. Add guard coverage for helper output and the most important prompt strings. Done in #391.
