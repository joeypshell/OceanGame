...
Update after #337: the formal acceptance checklist now reflects the latest compact HUD, pressure shell, lower-route, Decoy/Gulper, Wreck Echo planning, resource/scan, low-oxygen, upgrade, scanner-distinction, durable-progression, clean demo, surface-panel contrast, and debug hidden-state reviews. The current slice is structurally playable and close to polished acceptance, but it remains pass-with-watchlist until MCP refresh and future visual-change watchlists are cleared.
