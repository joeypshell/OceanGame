...
Latest milestone closeout: `docs/planning/HOLLOW_REEF_SIDE_CAVE_VALIDATION_2026_06_27.md` closes Hollow Reef Side Cave as pass with watchlist. The lower route now has a compact cave-like side branch with entrance/exit readability, a safe-return chain, one run-scoped cave-reading payoff, a visible closed deeper promise, deterministic visual evidence, and clear guardrails against minimap/checklist/cave-system drift.

Current active milestone: Lower-Route Expedition Goals. Existing issues #559 through #563 should make Blackwater, Dusk Trench, and Hollow Reef feel like a coherent player-visible route chain by improving ready-panel suggestions, route-choice/result memory priority, cheap scripted traversal evidence, oxygen-margin review, and milestone validation. Keep this focused on normal-play motivation and verification: no minimap, checklist, route graph, broad quest log, combat, harvesting, capture, monster-part economy, or full cave network.
