...
Current active milestone: Hollow Reef Side Cave. Existing issues #557 through #558 should finish turning the first cave-like side branch into a readable compact route with deterministic visual evidence and milestone validation. Keep it authored and compact: no full cave network, minimap, checklist, combat, harvesting, capture, monster-part economy, or broad procedural generation.
