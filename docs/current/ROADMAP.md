...
Latest milestone closeout: `docs/planning/LANTERN_RAY_CREATURE_ROUTE_VALIDATION_2026_06_27.md` closes Lantern Ray Creature Route as pass with watchlist. The lower route now has a passive scannable creature, a harmless timing/avoidance lane, compact result/recent-log memory, deterministic authored route variation, and clear guardrails that future monster-hunting should grow from observation and avoidance before upgrades or combat.

Current active milestone: Hollow Reef Side Cave. Existing issue #558 should close out the first cave-like side branch as a readable compact route with milestone validation. Keep it authored and compact: no full cave network, minimap, checklist, combat, harvesting, capture, monster-part economy, or broad procedural generation.
