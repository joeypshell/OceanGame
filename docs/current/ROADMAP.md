...
Latest milestone closeout: `docs/planning/DUSK_TRENCH_ROUTE_VALIDATION_2026_06_27.md` closes Dusk Trench Route Continuation as pass with watchlist. The lower ocean now continues beyond Blackwater into a darker route segment with a calm Glass Kelp side pocket, one run-scoped knowledge payoff, Low Visibility presentation, route memory, and deterministic visual evidence. The next work should add new player-visible gameplay through a lower-route creature milestone rather than repeatedly polishing Dusk.

Current active milestone: Lantern Ray Creature Route. Existing issues #546 through #551 should add one non-combat lower-route creature presence, make it scannable as behavior research, add one learnable timing lane, remember the observation compactly on extraction, give it one daily route-variation hook, and validate whether future monster-hunting work should continue from observation, avoidance, or upgrades. Avoid weapons, harvesting, capture, monster-part economy, health bars, field-guide objectives, minimaps, or broad creature progression until this first observation route is readable.
