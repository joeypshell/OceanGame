...
Current active milestone: Hollow Reef Interior And Wide Chamber. The next player-visible priority is route breadth: #568 now establishes Hollow Reef as a short reachable interior lane, #569-#573 should add small lane choices/payoffs/memory, and #574-#579 should add the first wider chamber beyond it. Keep this focused on normal-play map growth and readable return planning: no minimap, checklist, route graph, broad quest log, combat, harvesting, capture, monster-part economy, or full procedural cave network.
...
Hollow Reef interior lane: #568 adds the first short traversable lane beyond the Hollow Reef mouth and reading payoff. The lane remains authored scene geometry with no new collision, interaction, resource, predator, pressure, save, map, quest, or procedural cave ownership; its purpose is to make the side-cave route feel physically entered during normal play before later small lane choices and the wider chamber milestone.
