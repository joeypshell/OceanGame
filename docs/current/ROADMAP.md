...
Current active milestone: Hollow Reef Side Cave. Existing issues #552 through #558 should add the first cave-like side branch off the lower route with an entrance, exit readability, one knowledge payoff, safe-return cue, deeper promise, deterministic visual evidence, and milestone validation. Keep it authored and compact: no full cave network, minimap, checklist, combat, harvesting, capture, monster-part economy, or broad procedural generation.
