...
Current active milestone: Hollow Reef Interior And Wide Chamber. The next player-visible priority is route breadth: first complete the small #564-#565 polish gate for the most important lower-route readability asset, then use #568-#573 to make Hollow Reef a short interior lane and #574-#579 to add the first wider chamber beyond it. Keep this focused on normal-play map growth and readable return planning: no minimap, checklist, route graph, broad quest log, combat, harvesting, capture, monster-part economy, or full procedural cave network.
