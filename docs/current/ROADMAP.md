...
Wide chamber future-tool promise: #593 added compact Upgrade Bay planned/locked copy for the future `Salvage Cutter`; #619 supersedes that promise with the real, narrow `Salvage Cutter I` upgrade path. Keep remaining salvage work focused on opening and rewarding the existing Wide Reef sealed pocket rather than expanding into broad crafting, salvage inventory, or a tool tree.
