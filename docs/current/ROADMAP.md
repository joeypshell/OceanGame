...
Current active milestone: Next player-visible route-growth sequence. Use the completed First Meaningful Route Choice milestone as the baseline: new issues should add a short connected route sequence, payoff, or return-memory step that makes the ocean feel larger in normal play. Avoid reopening the first decision as another long review batch unless a concrete playtest failure appears.
