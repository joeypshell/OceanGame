...
Wide chamber future-tool promise: #593 adds compact Upgrade Bay planned/locked copy for the future `Salvage Cutter` after salvage-cache or recent `Wide Reef Chamber` context, without adding a selectable upgrade, cost, crafting recipe, save state, or purchase path.
