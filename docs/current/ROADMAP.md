...
Hollow Reef interior lane: #568 adds the first short traversable lane beyond the Hollow Reef mouth and reading payoff, and #569 adds a single optional upper-shelf choice inside that lane. Both remain authored scene geometry with no new collision, interaction, resource, predator, pressure, save, map, quest, or procedural cave ownership; their purpose is to make the side-cave route feel physically entered and locally explorable during normal play before later small payoffs and the wider chamber milestone.
