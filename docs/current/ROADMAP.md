...
Current active milestone: Hollow Reef Side Cave. Existing issues #555 through #558 should turn the first cave-like side branch into a readable compact route with a stronger safe-return cue, deeper promise, deterministic visual evidence, and milestone validation. Keep it authored and compact: no full cave network, minimap, checklist, combat, harvesting, capture, monster-part economy, or broad procedural generation.
