...
- Resource pickups use distinct prototype silhouettes: `Kelp Fiber` reads as green fronds/stem, `Shell Fragments` as pale ribbed shell shards, and `Glow Plankton` as a bioluminescent core/halo bloom. These visual differences do not change pickup count, collision, scan behavior, or resource identity.
