...
- Extraction and oxygen failure show a run result panel summarizing banked cargo, carried-cargo loss, one concise route-choice callout, durable upgrade progress, discoveries recorded or kept, next-expedition framing, and best depth.
