...
- Extraction and oxygen failure show an `Expedition Day N Result` panel summarizing the completed expedition day, banked cargo, carried-cargo loss, one concise route-choice callout, any compact Gulper research evidence, durable upgrade progress, discoveries recorded or kept, next-expedition framing, and best depth.
