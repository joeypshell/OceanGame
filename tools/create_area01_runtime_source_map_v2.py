...
OUTPUT_PATH = ROOT / "docs/planning/maps/area_01_runtime_source_map_v2.json"
...
def merge_validation_rules(
    ...
    merged["promoted_runtime_v2_single_source"] = (
        "Runtime v2 terrain visuals, collision polygons, rim trims, interaction hooks, debug overlays, and previews must derive from this source map."
    )
...
def main() -> None:
    ...
    output = {
        ...
        "source_inputs": {
            ...
            "current_runtime_blockout": str(CURRENT_BLOCKOUT_PATH.relative_to(ROOT)).replace("\\", "/"),
        ...
        "migration_plan": [
            {
                "step": 1,
                "task": "Generate preview from this file and verify it matches accepted v3 terrain-kit direction.",
                "status": "complete",
            },
            {
                "step": 2,
